...
for i, file in enumerate(file_list):
    ...
    if sample_name == "123" or sample_name == "234":
        print("MC_124")
        os.system("cp ../analyzer_MC_124.C ./")
        os.system(r"nohup root -l -q -b analyzer_MC_124.C\(\"" + file + r"\"," + str(int(index_number)) + "," + str(0) + "\) &")
    else:
        os.system("cp ../analyzer_MC_131_dev.C ./")
        print(r"nohup root -l -q -b analyzer_MC_131_dev.C\(\"" + file + r"\"," + str(int(index_number)) + "," + str(0) + "\) &")
        # os.system(r"nohup root -l -q -b analyzer_MC_131_dev.C\(\"" + file + r"\"," + str(int(index_number)) + "," + str(0) + "\) &")
