...
void analyzer_Data(TString filename, int ifile) {
    ...
    TH1F* hist1_1 = new TH1F("hist1_1", "B mass (all triplet)", 1000, 3, 8);
		...
		TH1F* hist1_14 = new TH1F("hist1_14", "#Delta z (l1, K) (all triplet)", 1000,-20,20);
		TH1F* hist1_15 = new TH1F("hist1_15", "#Delta z (l2, K) (all triplet)", 1000,-20,20);
		TH1F* hist1_16 = new TH1F("hist1_16", "SigImpactParam(K, ll) (all triplet)", 1000,-1000,1000);
		...
		TH1F* hist1_20 = new TH1F("hist1_20", "Momentum asymmetry (all triplet)", 1000, 0,1);
		...
		TH1F* hist2_1 = new TH1F("hist2_1", "B mass (quadruplet)", 1000, 3, 8);
